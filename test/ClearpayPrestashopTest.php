...
/**
 * Class AfterpayPrestashopTest
 * @package Test\Selenium
 */
abstract class AfterpayPrestashopTest extends TestCase
{
    ...
    protected $configuration = array(
        ...
        'firstname'     => 'Jøhn',
        'lastname'      => 'Dōès',
        'email'         => 'john_doe_testing@afterpay.com',
        'company'       => 'Afterpay SA',
        'zip'           => '08023',
        'city'          => 'Barcelona',
        'state'         => 'Barcelona',
    ...
    public function __construct($name = null, array $data = array(), $dataName = '')
    {
        ...
        $this->configuration['email'] = date('ymd') . '@afterpay.com';
    ...
    {
        $this->webDriver = AfterpayWebDriver::create(
    ...
    public function getProperties()
    {
        return array(
            ...
            'FORM_DISPLAY_TYPE' => '0',
            'AFTERPAY_MIN_AMOUNT' => '1',
            'AFTERPAY_MAX_AMOUNT' => '0',
            'URL_OK' => '',
            'URL_KO' => '',
        );
    }
