 ...
 */
class AfterpayPs16ControllerTest extends AfterpayPrestashopTest
{
    /**
     * log route
     */
    const LOG_FOLDER = '/index.php?fc=module&module=afterpay&controller=log&limit=100&from=20200101&product=AFTERPAY';
