...
class ValidatePs17Test extends AbstractPs17Selenium
{
    ...
    public function testConfirmationPage()
    {
        ...
        $afterpayOption = WebDriverBy::cssSelector('[for=payment-option-3]');
        $condition = WebDriverExpectedCondition::elementToBeClickable($afterpayOption);
        $this->waitUntil($condition);
        $this->assertTrue((bool) $condition);
        $this->webDriver->findElement($afterpayOption)->click();
